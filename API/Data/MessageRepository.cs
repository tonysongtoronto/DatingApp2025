...
public class MessageRepository(AppDbContext context) : IMessageRepository
{
        ...
        messageParams)
    {
        ...
        {
            "Outbox" => query.Where(x => x.SenderId == messageParams.MemberId && x.SenderDeleted==true),
            _ => query.Where(x => x.RecipientId == messageParams.MemberId && x.RecipientDeleted==true)
        };
    ...
    public async Task<IReadOnlyList<MessageDto>> GetMessageThread(string currentMemberId, string recipientId)
    {
        ...
        return await context.Messages
            .Where(x => (x.RecipientId == currentMemberId && 
            x.SenderId == recipientId && x.RecipientDeleted==false)
